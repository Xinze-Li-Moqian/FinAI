# AI-Agent / Generative AI homework — 10%

[Course home](../../README.md) · [Part 1 progress](part1/README.md#current-progress) · [Course assessment details](../../course-info/README.md#assessment-and-deliverables)
...
The planned hierarchy is Claim → Theme → Argument → Evidence & EvolutionOverTime. Preserve each claim's author, date, and supporting passage. A title-based theme suggestion is not a verified claim.

The [received prompt-pipeline package](../../materials/07_Prompt_Pipeline/) contains instructor code and sample outputs. Those samples are not our submission or reproduced results. Confirm the detailed Part 2 requirements and deadline before creating the final deliverable. A small transcript-level analysis can proceed using the available corpus while downloads are unresolved.
